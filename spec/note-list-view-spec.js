function testViewOneNote() {
  ...
  assert.isEqual(noteListView.html(), '<ul><li><div>Note test<div><li><ul>')
}
...
function testViewNotes() {
  ...
  assert.isEqual(noteListView.html(), '<ul><li><div>Note test</div></li><li><div>Note test 2</div></li></ul>');
}
